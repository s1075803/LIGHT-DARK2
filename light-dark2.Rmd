...
##MANOVA
```{r}
res.man <- manova(cbind(lightdark2$TotalSecZ1, lightdark2$TotalSecZ2, lightdark2$TotalSecAmbZ1, lightdark2$TotalSecAmbZ2) ~ lightdark2$LOCATION, data = lightdark2)
